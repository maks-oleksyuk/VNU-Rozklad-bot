...
messages = {
    ...
    'process_lesson': '✅ Дата введена успішно\n\n'
                      + 'Введіть номер пари\\.\\.\\.',

    'process_lesson_success': '✅ Номер пари введено успішно\n\n'
                              + 'Оберіть потрібний корпус\\.\\.\\.',

    'process_lesson_error': '❗️ Введено некоректні дані\n'
                            + '🌀 Повторіть спробу ще раз',

    'process_block_success': '✅ Корпус обрано успішно\n\n'
                             + 'Можливі неточності з поверхами 🤷\n'
                             + 'Оберіть потрібний поверх\\.\\.\\.',

    'process_block_success_type': '✅ Корпус обрано успішно\n\n'
